    ...
    <div class="internalRow">
      <div class="AreaGroupCabecalho">
        <div class="logoAndInputArea">
          <div class="logo-area">
            <div class="areaButtonMenuResponsivo">
              <img
          ...
          <form action="#" id="busca" class="formSearch">
            ...
            <button class="btn-search">
              <img src="images/icons/icon-buscar.svg" alt="ícone de busca" />
            </button>
          </form>
        </div>

        <div class="areaAccountCartResponsive">
          <img
            class="userMenu"
